...
ITEM_NAMES = {
    ...
    'S1_stmt': 'St1 Sanction systems applied consistently',
    'S2_stmt': 'St2 Reward systems applied consistently',
    'S3_stmt': 'St3 Teacher turnover is low',
    'S4_stmt': 'St4 Staff morale is good',
    'S5_stmt': 'St5 Pupil behaviour in class is generally good',
    'S6_stmt': 'St6 Pupil behaviour outside class is generally good',
    'S7_stmt': 'St7 Pupils feel safe at school',
    'S8_stmt': 'St8 Pupils feel their teachers care',
    'S9_stmt': 'St9 Teachers feel respected by pupils',
    # Yes/no systems
...
def build_scoring_guide() -> str:
    ...
    L = [r'% Auto-generated by thesis/make_instruments.py --- do not edit by hand.',
         ...
         r'\caption{Composition of the gold-standard sub-scores}',
         ...
         r'\endfoot',
         r'\bottomrule',
         r'\multicolumn{3}{@{}p{\linewidth}@{}}{\footnotesize\textit{Notes:} Item'
         r' wording is given in full in \cref{app:2A:interview_guide} and'
         r' \cref{app:2A:visit_protocol}.} \\',
         r'\endlastfoot']
    group = None
