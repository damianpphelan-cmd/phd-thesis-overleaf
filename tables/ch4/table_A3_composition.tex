...
\smallskip
\footnotesize
\textit{Notes:} Shares of each group in the GCSE cohort, among university students, and among economics undergraduates, for three cohorts. Shares may not sum to 100 due to omitted categories.
\end{minipage}
\end{table}
