...
\toprule
                                          & \multicolumn{4}{c}{KS5 school offer type} \\
\cmidrule(l{3pt}r{3pt}){2-5}
KS4 school offer type                     & Always     & Switcher   & Never      & Total      \\
\midrule
...
\smallskip
\footnotesize
\textit{Notes:} Panel~A shows the distribution of students across school transition types. ``Same school'' includes students who remain at the same institution and those who transfer to a linked feeder school. School offer type is defined by whether the school offers A-level economics in the relevant cohort year. Panel~B compares A-level economics take-up rates across transition types. Similar take-up rates between movers who gain access and non-movers at offer schools suggest that school moves are not driven by demand for economics. Sample: GCSE cohorts 2002--2008, students continuing to KS5.
\end{minipage}
\end{table}
