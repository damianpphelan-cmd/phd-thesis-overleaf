...
pair. Panel B rests on 817 predecessor--successor bridging rows (453 converter, 335
sponsor-led, 29 other); these are raw event-time means, not a matched event study.
Sponsor-led academies are taken over from a much lower base and close roughly half the
gap over eight years; converters start near zero and drift slightly upward.
\end{minipage}
\end{table}
