\begin{table}[htbp]
  ...
  \begin{tabular}{llrrrrr}
    ...
    \bottomrule
  \end{tabular}
  \caption{Progress~8 outcomes: summary statistics}
  \label{tab:outcome_stats}
  \begin{minipage}{\linewidth}
    \vspace{2pt}
    \footnotesize
    \textit{Notes:} The interviewed sample numbers 303 schools and contains the 103 visited schools; $N$ falls short of 303 where an outcome is unpublished for a school. P8 outcomes are 2-year averages of 2022--23 and 2023--24 component scores where both
