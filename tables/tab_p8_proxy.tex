...
A & Marking-scheme bands & 3{,}076 & 0.152\sym{***} & 0.131\sym{***} & 0.132\sym{***} & 0.129\sym{***} \\
...
B & Marking-scheme bands & 2{,}753 & 0.152\sym{***} & 0.133\sym{***} & 0.133\sym{***} & 0.127\sym{***} \\
 & & & (0.010) & (0.010) & (0.010) & (0.008) \\
\bottomrule
\end{tabular}
\begin{minipage}{\linewidth}
\smallskip
\footnotesize\textit{Notes:} The pseudo measure is the part of a school's 2024/25 Attainment 8 that is not predicted by its Key Stage 2 intake, averaged over several years and standardised. It is a progress-like score for the cohort measured at the time of the fieldwork. Each cell is the (standardised) culture coefficient from the same specification run on the pseudo outcome and on real (2022--24 average) Progress~8 for the same schools, without (A) and with (B) the predecessor-filled 2019 inspection-grade control; late-entry schools excluded. Standard errors (HC3) in parentheses.
\sym{*} \(p<0.10\), \sym{**} \(p<0.05\), \sym{***} \(p<0.01\).
 The same construction, rebuilt one year earlier from the 2021--22 and 2022--23 baselines, correlates with the real 2023--24 Progress~8 at $+0.81$ ($n = 3{,}242$). The marking-scheme rows use the strictness
