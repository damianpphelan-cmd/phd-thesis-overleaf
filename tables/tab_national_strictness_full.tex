...
Strictness (Ofsted LLM, per SD) & 0.138\sym{***} & 0.122\sym{***} & 0.121\sym{***} & 0.144\sym{***} & 0.159\sym{***} \\
...
Strictness (Ofsted LLM, per SD) & 0.140\sym{***} & 0.126\sym{***} & 0.123\sym{***} & 0.147\sym{***} & 0.158\sym{***} \\
