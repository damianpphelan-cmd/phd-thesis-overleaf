...
\bottomrule
\end{tabular}
\caption{Structural stability of school characteristics: intra-class
correlations and year-on-year change, 2015--16 to 2024--25}
\label{tab:structural_stability}
\begin{minipage}{\linewidth}
\smallskip
\footnotesize\textit{Notes:} ICC = intra-class correlation = between-school
...
Care plan; SEN = special educational needs. KS2 scaled score
(\texttt{perf\_ks4\_ks2ass}, centred on 100) and KS2 Average Point Score
(\texttt{perf\_ks4\_ks2aps}) use different scales from successive assessment
frameworks and are therefore reported separately; no KS4 performance data
...
schools) and Academies Accounts Return (academies); 2015--16 CFR data are
absent and 2024--25 returns are incomplete at time of writing.
\end{minipage}
\end{table}