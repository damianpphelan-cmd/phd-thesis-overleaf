...
\smallskip
\footnotesize\textit{Notes:} Each column regresses a school's 2023--24 share of pupils with social, emotional and mental-health (SEMH) needs, as a percentage of the roll, on one culture score plus the school's 2015--16 baseline SEMH share and the primary control set: visited-school strictness and warmth ($n=94$ visited schools), and the national marking-scheme strictness bands ($n=2{,}594$). Coefficients are percentage points per standard deviation of the score. Nationally, stricter schools have a slightly lower current SEMH share given their 2015--16 share. In the visited sample the sign is the same but the estimate is imprecise. This is consistent with some sorting of pupils by school strictness. Adding the baseline share to the main regression reduces the strictness coefficient by under a tenth.
