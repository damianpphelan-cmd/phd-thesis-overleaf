\begin{table}[htbp]\centering\caption{National extension: Ofsted LLM strictness and Progress~8}
...
\begin{minipage}{\linewidth}
  ...
  the primary visited-sample specification---and is estimated on the 2{,}746 schools with
