...
\caption{Sensitivity to unmeasured confounding}
...
\midrule
Warmth ($W$) & 0.146 & 0.082 & 1.71 & 0.112 & 1.99 & 1.50 \\
Strictness ($S$) & 0.106 & 0.145 & 1.09 & 0.013 & 1.76 & 1.27 \\
\bottomrule
\end{tabular}
...
scores. Oster's $\delta$ \citep[via \texttt{psacalc}]{oster2019} is the strength of
