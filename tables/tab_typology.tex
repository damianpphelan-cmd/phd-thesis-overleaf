...
\begin{tabular}{lccc}
\toprule
 & Gold visits & \multicolumn{2}{c}{National (text instruments)} \\
\cmidrule(lr){3-4}
 & & Panel A & Panel B \\
\midrule
...
Quadrant means are covariate-adjusted; gold quadrants are median splits within the
visited sample. The gold interaction is a low-power test at this sample size; the
