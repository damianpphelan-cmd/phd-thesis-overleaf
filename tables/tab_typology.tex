...
\addlinespace[2pt]
Authoritative (high $W$, high $S$) & $+$0.522 (0.068) & $+$0.351 (0.033) & $+$0.289 (0.034) \\
   & $n=32$ & $n=90$ & $n=84$ \\
Authoritarian (low $W$, high $S$)  & $+$0.216 (0.104) & $+$0.332 (0.024) & $+$0.277 (0.024) \\
   & $n=17$ & $n=356$ & $n=334$ \\
Permissive (high $W$, low $S$)     & $+$0.298 (0.113) & $+$0.167 (0.043) & $+$0.174 (0.043) \\
   & $n=17$ & $n=57$ & $n=54$ \\
Neglectful (low $W$, low $S$)      & $+$0.054 (0.062) & $-$0.052 (0.007) & $-$0.022 (0.007) \\
   & $n=33$ & $n=2{,}549$ & $n=2{,}274$ \\
\midrule
\multicolumn{4}{l}{\textit{Regression tests}} \\
\addlinespace[2pt]
Warmth ($W$)             & 0.145\sym{***} & 0.030\sym{***} & 0.028\sym{***} \\
                         & (0.045) & (0.007) & (0.007) \\
Strictness ($S$)         & 0.116\sym{***} & 0.130\sym{***} & 0.129\sym{***} \\
                         & (0.042) & (0.009) & (0.009) \\
$W \times S$ interaction & 0.039 & 0.018\sym{***} & 0.016\sym{***} \\
                         & (0.033) & (0.004) & (0.005) \\
Authoritative vs rest    & 0.370\sym{***} & 0.290\sym{***} & 0.269\sym{***} \\
                         & (0.087) & (0.034) & (0.034) \\
\midrule
$N$                      & 99 & 3{,}052 & 2{,}746 \\
\bottomrule
