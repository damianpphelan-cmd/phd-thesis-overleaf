...
\addlinespace[2pt]
Authoritative (high $W$, high $S$) & $+$0.547 (0.066) & $+$0.351 (0.033) & $+$0.289 (0.034) \\
   & $n=33$ & $n=90$ & $n=84$ \\
Authoritarian (low $W$, high $S$)  & $+$0.142 (0.075) & $+$0.332 (0.024) & $+$0.277 (0.024) \\
   & $n=16$ & $n=356$ & $n=334$ \\
Permissive (high $W$, low $S$)     & $+$0.380 (0.073) & $+$0.167 (0.043) & $+$0.174 (0.043) \\
   & $n=15$ & $n=57$ & $n=54$ \\
Neglectful (low $W$, low $S$)      & $+$0.035 (0.058) & $-$0.052 (0.007) & $-$0.022 (0.007) \\
