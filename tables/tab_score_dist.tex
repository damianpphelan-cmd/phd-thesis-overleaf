...
\midrule
Warmth & \emph{enacted} & 103 & 6.37 & 0.94 & 4.25 & 6.40 & 8.72 \\
...
\bottomrule
\end{tabular}
\caption{Distribution of the scores and sub-scores}
\label{tab:score_dist}
\begin{minipage}{\textwidth}\vspace{0.5em}\footnotesize
\textit{Notes.} Distribution of sub-scores and of the enacted and espoused scores for the visited schools with full data ($n = 103$). Sub-scores are on a $[0,5]$ scale; the enacted and espoused scores on a $[0,10]$ scale. The enacted scores are built from the visit sub-scores
