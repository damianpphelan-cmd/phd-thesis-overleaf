\begin{table}[htbp]
\centering
\caption{Distribution of the sub-scores and scores}
...
\textit{Notes:} The visited schools with full data ($n = 103$); sub-scores and scores are on the same $1$--$5$ scale as the items. The enacted scores are built from the visit sub-scores
