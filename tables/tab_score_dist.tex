...
\smallskip
\footnotesize\textit{Notes:} Distribution of sub-scores and of the enacted and espoused scores for the visited schools with full data ($n = 103$). Sub-scores are on a $[0,5]$ scale; the enacted and espoused scores on a $[0,10]$ scale.
\end{minipage}
\end{table}
