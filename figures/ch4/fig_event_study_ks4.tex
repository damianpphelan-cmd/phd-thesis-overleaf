...
respectively. The number of schools contributing at each event time is
reported in Appendix Table~\redbf{X}. A joint test of the pre-change
coefficients gives $p = \redbf{XX}$ for Panel A and $p = \redbf{XX}$
for Panel B.}
\end{singlespace}
\end{figure}
