...
% =====================================================================
\begin{figure}[p]
\caption{Event study: A-level economics take-up around provision changes}
...
provision, estimated on switcher schools only. The outcome is the share of
...
in Appendix Table~\ref{tab:eventstudy_counts}. A joint test of the
pre-change coefficients gives $p = 0.81$ for Panel A and $p = 0.54$ for
Panel B.}
\end{singlespace}
\end{figure}
