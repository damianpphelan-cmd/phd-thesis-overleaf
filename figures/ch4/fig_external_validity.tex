...
year; best 3 A-level points are measured among A-level entrants only. They are
determined after the student has been exposed to the school's economics
provision, so unlike KS4 scores they are not a pre-treatment
characteristic.}
\end{singlespace}
\end{figure}
