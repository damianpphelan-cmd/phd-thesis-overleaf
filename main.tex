...
against a one-page mark scheme. Inspection reports contain a modest signal of
both. Warmth shows in a report's everyday wording. Strictness shows in
specific statements, for example that conduct standards are consistently
enforced, which a reader has to be told to look for. What a headteacher says about their school is not what observers find
there, the gap is widest for warmth, and schools' own documents match what
heads say rather than what observers record.
...
suitably qualified teacher, and during the period we study fewer than half
of state schools did. Within-school
changes in provision raise take-up by 5.7 percentage points, and taking the
subject raises earnings at age 28 by around 14 per cent, an implied net
lifetime gain of \pounds 65,000--\pounds 90,000 for each student induced to
take it. Hiring
an economics teacher more than pays for itself fiscally, and universal
provision would shift the subject's intake towards regions outside London and
the South East.
