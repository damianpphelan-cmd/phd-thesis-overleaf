...
The first paper measures culture. In \NTierOne{} schools, a day of structured
observation recorded what each school does, and an interview recorded what
its headteacher says it does, on two dimensions: warmth, the relational
quality of the school, and strictness, its behavioural structure. Every
...
against a one-page mark scheme. Inspection reports carry a modest signal of
both dimensions, through different routes: warmth shows in a report's
everyday wording, strictness in specific claims a reader must be told to look
for. What a headteacher says about their school is not what observers find
there, the gap is widest for warmth, and schools' own documents match what
heads say rather than what observers record.

The second paper relates the observed scores to Progress~8, holding intake,
school characteristics and the pre-pandemic inspection grade constant. A
standard deviation of observed warmth is associated with \PrimarySpecWSD{} of
a standard deviation of Progress~8, and a standard deviation of observed
strictness with \PrimarySpecSSD{}; the quality of the teaching observed
accounts for neither. Warmth predicts progress only when it is measured by
...
headteacher. Culture scores read from inspection reports extend both
associations to effectively all English state secondary schools.
...
suitably qualified teacher, and fewer than half of schools do. Within-school
...
lifetime gain of \pounds 65,000--\pounds 90,000 per induced student. Hiring
