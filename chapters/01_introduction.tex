...
what the observed scores predict. The second question depends on the
first. The first paper checks the text-based scores against the visit
scores. Only the scores from inspection reports agree with them. The second
paper therefore uses the visit scores for the visited schools, and the
...
for. Behaviour policies and websites contain no information about either
that matches what observers record. Their scores agree with what the headteacher says about
...
The paper then costs the remedy: employing a qualified teacher at each
school without the subject. One teacher is enough to let a school offer
it. Pupils who take the subject go on to earn more,
