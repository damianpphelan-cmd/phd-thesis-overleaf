...
checks the text-based scores against that direct measure. The second paper
then uses only the text-based scores that agreed with the visit scores,
which are the scores from inspection reports.
