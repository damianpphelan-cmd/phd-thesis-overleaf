...
separating most cleanly, and the five that cross are near-ties or weakly
loaded items about order in transitions. When the ten teaching items are
added they form the dominant factor, and eighteen of the nineteen culture
items then sort with their assignment. The factors are extracted as
orthogonal, so the check if anything understates the overlap between two
dimensions the chapter estimates to correlate at about $0.36$.
