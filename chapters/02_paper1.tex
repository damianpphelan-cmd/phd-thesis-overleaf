...
carry a modest but real signal of enacted warmth. A prediction model reading only the report's wording predicts the enacted warmth of schools it was not estimated on. Its predictions correlate with what the observers recorded at $\PredWOfsted$, with a 95 per cent confidence interval of $\CIPredWOfsted$. Before intake is removed from the target the correlation is $\PredWOfstedRaw$. The fact that removing intake strengthens the signal
