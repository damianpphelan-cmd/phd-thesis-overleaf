...
structured interview with its headteacher. For a further \NTierTwo{} schools we have the interview alone. Those schools are not used for the enacted measures, which need a visit, but they widen the sample for one later test: whether what a school writes about itself matches what its headteacher says.
