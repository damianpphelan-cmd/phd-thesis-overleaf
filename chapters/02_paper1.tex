...
\begin{minipage}{\linewidth}\smallskip
\footnotesize\textit{Notes:} The comparison is with the national population of open secondary and all-through schools in England. Bars show the percentage of schools in each region for the national population ($n = 3{,}312$), interviewed schools ($n = 300$), and visited schools ($n = 102$), the tier members matched to the school panel (the 2023/24 regional characteristics panel holds 3{,}312 of the 3{,}332 analysis-panel schools; the remainder lack a region record at that date). Regions are ordered by national share. Both samples over-represent London, and the interviewed sample the South East; the visited sample is particularly concentrated in London (45.1\% versus 15.0\% nationally). $\chi^2$ goodness-of-fit tests reject equal regional composition for both samples ($p < .001$).
\end{minipage}
\end{figure}
