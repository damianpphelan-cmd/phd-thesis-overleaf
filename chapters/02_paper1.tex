...
the same rubric should find the same thing. For strictness, the second model reads the enacted scores at $\RubricSFourO$, close to the primary model's $\RubricSOfstedRaw$, so the scheme rather than the model is doing the work. For warmth 
