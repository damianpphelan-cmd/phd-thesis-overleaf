...
two dimensions as warmth and strictness. I then ask how well each dimension can be predicted from publicly available texts that exist for all 3,332 schools in the country.
