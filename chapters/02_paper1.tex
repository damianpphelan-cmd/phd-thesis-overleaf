...
Demographic adjustment is separate from the three checks: as set out in the measurement section, every reading is computed both raw and with everything demographics could explain removed. The adjustment changes the strictness reading little: the scheme scores $\RubricSOfstedRaw$ raw and $\RubricSOfstedDec$ adjusted. The warmth scheme fails entirely: it reads the reports at $\RubricWOfstedDec$ and 
