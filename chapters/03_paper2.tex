...
neither touches reverse causality. They are also conservative. The culture
scores measure a school with error, and error of that kind biases a
coefficient towards zero. The true coefficients are therefore, if anything,
larger than the estimated ones, and the bounds computed from them would be
larger too.
