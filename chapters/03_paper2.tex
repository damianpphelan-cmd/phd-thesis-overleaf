...
would show up as movement in both directions. Thirdly, the culture association
...
contains no information about progress, and what they say about behaviour
systems contains some. This is the pattern that the previous chapter's
...
is really the grade's association under another name. However, the coefficient is
untouched by conditioning on the grade, and a proxy for the grade would lose
most of its coefficient when the grade entered. What the score captures is
