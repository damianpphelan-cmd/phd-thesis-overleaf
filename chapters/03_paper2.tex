...
should be noted that both measures address omitted variables only. Neither
touches reverse causality, and because the culture scores are measured with
error, the estimated coefficients, and with them the bounds, are if
