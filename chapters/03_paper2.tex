...
[$+0.039$, $+0.086$] for teaching, both comfortably away from zero. Excluding the
...
and to languages, by two to three percentage points per band standard
deviation, with or without the grade control. However, controlling for
EBacc entry reduces the bands' association with the EBaC component by
