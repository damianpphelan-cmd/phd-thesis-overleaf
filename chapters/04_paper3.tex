...
% Result 2: Impact
Second, we estimate the causal effect of taking A-level economics on earnings. The first stage is strong: within-school availability of A-level economics increases the probability of taking the subject by 5.7 percentage points ($F = 843$). Students induced to take A-level economics are 15.2 percentage points more likely to study economics at university, confirming the gateway role documented in our descriptive analysis. The IV estimate implies that taking A-level economics raises earnings at age 28 by around 14\%. Using a forward-simulation approach following \citet{britton2020degrees}, we estimate that the lifetime earnings gain is approximately \redbf{\pounds 100,000} in present value (gross) and \redbf{\pounds 65,000} net of tax and student loan repayments.
...
The IV estimate of the gross lifetime earnings gain from taking A-level economics is approximately \redbf{\pounds 100,000} in present value (Table~\ref{tab:main} Panel C). Net of income tax, National Insurance (social security), and student loan repayments, the private lifetime gain is \redbf{\pounds 65,000}. The fiscal return, measured by the additional tax revenue and reduced loan write-off cost generated by the higher earnings, is \redbf{\pounds 35,000} per student. This fiscal figure, along with analogues constructed for different subgroups (Section~\ref{sec:heterogeneity} below), is the key input to the MVPF calculation in Section~\ref{sec:Policy}.

The saturated specification gives a gross lifetime gain of \redbf{\pounds 108,000}, close to the linear estimate, so the weighting concern of \citet{blandhol2022tsls} matters no more for lifetime earnings than it does for earnings at age 28.
...
The composition-adjusted average fiscal return per student from universal provision is \redbf{\pounds 32,000}. With a first-stage takeup effect of 5.7 percentage points and an average cohort size of \redbf{40} in never-offer schools, each school cohort generates an average fiscal return of approximately \redbf{\pounds 80,000}. Over a \redbf{10-year} teaching career, the total discounted fiscal return is \redbf{\pounds 690,000}. Since this exceeds the \redbf{\pounds 575,000} cost of a teacher, the MVPF is infinite: the policy more than pays for itself, with a fiscal surplus of \redbf{\pounds 115,000} per teacher (Table~\ref{tab:mvpf} Panel~A). Among the 133 historical US policies evaluated by \citet{hendren2020mvpf}, an infinite MVPF places this intervention alongside the highest-return investments in children's education and health.

The UK government currently offers training bursaries of up to \pounds 30,000 for shortage subjects, principally in science and mathematics, recognising the high value of expanding teacher supply in those fields. Economics does not receive such a bursary. Given the returns documented here, a comparable incentive would be justified: with a \pounds 30,000 training bursary, the fiscal surplus per teacher would still be \redbf{\pounds 85,000},
