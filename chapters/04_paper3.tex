...
Panel~B of Table~\ref{tab:main} reports the main results. The OLS estimate of the effect of taking A-level economics on log earnings at age 28 is 0.175, suggesting that students who take economics earn approximately 19\% more than observationally similar students who do not. The IV estimate is smaller: taking A-level economics raises earnings at age 28 by around 14\%.\footnote{Re-estimating the IV with earnings in pounds rather than logs gives \pounds 3,700 (standard error \pounds 3,300). The point estimate is consistent with the log specification, but earnings in levels are noisy, so the estimate is imprecise. The levels sample ($N = 406{,}352$) also retains students with zero earnings, whom the log specification excludes.}
