...
The implied lifetime gain is constructed mainly from the shift into economics degrees, which carry among the highest lifetime returns of any subject. The 15.2 percentage point increase in economics degree take-up among compliers, combined with a net lifetime return to an economics degree of around \pounds 560,000 \citep{britton2026lifetime}, accounts for roughly 85\% of the calculation. The age-28 evidence points to broader channels: the observed earnings gains sit mainly with compliers who do not change degree subject. We therefore also report an alternative construction based on persistence of the age-28 premium, which gives a similar order of magnitude.
