...
Table~\ref{tab:mvpf} Panel~B shows who would benefit. Schools that do not currently offer economics disproportionately serve students from economically disadvantaged backgrounds. As well as being fiscally beneficial, expansion of access therefore also shifts the composition of the economics pipeline, though the movements are modest. Universal access would raise the share of economics undergraduates from outside London and the South East from 51\% to 53\% --- still short of the two-thirds of students who attend school outside London and the South East --- while leaving the shares of women and of FSM students roughly unchanged, at 28\% and 7\%. The female share barely moves because women's take-up response to availability is small; the gender gap is a matter of conditional take-up rather than access, as Section~\ref{sec:Access} showed.
