...
% Result 2: Impact
Second, we estimate the causal effect of taking A-level economics on earnings. The first stage is strong: within-school availability of A-level economics increases the probability of taking the subject by 5.7 percentage points ($F = 843$). Students induced to take A-level economics are 15.2 percentage points more likely to study economics at university, confirming the gateway role documented in our descriptive analysis. The IV estimate implies that taking A-level economics raises earnings at age 28 by around 14\%. Combining our estimates with published estimates of lifetime returns by degree subject \citep{britton2026lifetime}, the implied lifetime gain is approximately \redbf{\pounds 190,000} in present value (gross) and \redbf{\pounds 90,000} net of tax and student loan repayments.
...
The earnings effect is partly explained by a shift into economics degrees, which have among the highest lifetime returns of any subject: the 15.2 percentage point increase in economics degree take-up among compliers, combined with the estimated net lifetime return to an economics degree of over \pounds 400,000 \citep{britton2026lifetime}, accounts for roughly \redbf{85\%} of the implied lifetime gain.
...
We restrict the sample to the 2002--2009 GCSE cohorts, for whom we observe earnings at age 28 (the latest year in our earnings data is 2021). We focus on age-28 earnings as the primary outcome because it is the latest age observed for all cohorts, and combine these estimates with published estimates of lifetime returns by degree subject \citep{britton2026lifetime} to assess lifetime effects.
...
\begin{equation}
\label{eq:implied}
0.140 \times \bar{R} \;+\; 0.152 \times \left(R_{\text{econ}} - R_{\text{mix}}\right) \;\approx\; \text{\redbf{\pounds 90,000}},
\end{equation}
%
where $\bar{R} = \text{\pounds 99,000}$ is the average net lifetime return to an undergraduate degree; $R_{\text{econ}}$ is the return to an economics degree, \redbf{\pounds 570,000} when the published returns of \redbf{\pounds 650,000} for men and \redbf{\pounds 335,000} for women are weighted by the male share of economics students in our sample; and $R_{\text{mix}}$ is the return to the subjects compliers would otherwise study, \redbf{around \pounds 75,000} when the counterfactual bundle in Table~\ref{tab:subject_triples} Panel~B --- principally business, English literature, history and psychology --- is weighted by the published returns to those subjects. The first term captures compliers drawn into university altogether; the second captures compliers who switch into economics from another subject. The same margins applied to the published exchequer schedule imply an exchequer return of roughly \redbf{\pounds 100,000}, and the gross return, roughly \redbf{\pounds 190,000}, follows from the accounting identity that the gross return approximately equals the sum of the net individual and exchequer returns (Table~\ref{tab:main} Panel~C). As a check on the order of magnitude, assuming instead that the 14\% age-28 earnings premium persists over the lifecycle gives a net gain of around \redbf{\pounds 65,000}.
...
The composition-adjusted average exchequer return per student from universal provision is \redbf{\pounds 92,000}. With a first-stage takeup effect of 5.7 percentage points and an average cohort size of \redbf{40} in never-offer schools, each school cohort generates an average exchequer return of approximately \redbf{\pounds 210,000}. Over a \redbf{10-year} teaching career, the total discounted exchequer return is \redbf{\pounds 1.8 million}. Since this exceeds the \redbf{\pounds 575,000} cost of a teacher, the MVPF is infinite: the policy more than pays for itself, with a fiscal surplus of \redbf{\pounds 1,230,000} per teacher (Table~\ref{tab:mvpf} Panel~A). Among the 133 historical US policies evaluated by \citet{hendren2020mvpf}, an infinite MVPF places this intervention alongside the highest-return investments in children's education and health. This calculation prices only the degree-choice channel; Panel~B of Table~\ref{tab:degree_channel} shows that much of the age-28 return arises outside it, so the fiscal return is understated and the conclusion is conservative.

The UK government currently offers training bursaries of up to \pounds 30,000 for shortage subjects, principally in science and mathematics, recognising the high value of expanding teacher supply in those fields. Economics does not receive such a bursary. Given the returns documented here, a comparable incentive would be justified: with a \pounds 30,000 training bursary, the fiscal surplus per teacher would still be \redbf{\pounds 1,200,000},
